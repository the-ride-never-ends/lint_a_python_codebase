Feature: Remove Identifier Files
  As a developer using WSL
  I want to remove all .Identifier files from my directory tree
  So that these problematic files don't interfere with my development

  Background:
    Given a target directory structure
